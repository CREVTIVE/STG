class Box {
  ...
  drawTextures(){
    ...
    var thisAdjust = this.pgA.height/2 + this.pgTextSize/4;
    ...
    var thisAdjustB = this.pgB.height/2 + this.pgTextSize/4;
    this.pgB.text(this.inp, this.pgA.width/2, thisAdjustB);
  }
